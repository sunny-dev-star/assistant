...
本项目采用**双授权（dual-license）**模式：

- **开源授权**：[GNU AGPL-3.0](./LICENSE) —— 个人、研究、内部非商用，以及愿意开源自身衍生代码的项目可免费使用；通过网络提供服务须公开完整衍生源码。
- **商业授权**：如需在闭源/专有产品或 SaaS 多租户中使用而不履行 AGPL 义务，或需要发票、技术支持、私有化部署协助，请购买商业授权，详见 [COMMERCIAL-LICENSE.md](./COMMERCIAL-LICENSE.md)。

部分企业级模块（多租户管理控制台、企业 SSO、高级渠道包、行业付费技能等）不在开源范围内，仅向商业授权客户提供。
